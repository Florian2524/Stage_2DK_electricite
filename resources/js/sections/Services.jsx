  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-6xl px-6 md:px-10 xl:px-16">
        {/* En-tête compact, align typographique des H2 du site */}
            ...
            >
              <div className="relative aspect-[16/11] md:aspect-[4/3]">
                ...
                <div className="absolute inset-x-0 bottom-0 p-5 md:p-6">
                  ...
                  <p className="mt-2 text-white/90 text-sm leading-snug opacity-0 translate-y-1 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
                    {item.description}
                  </p>
                </div>
              </div>
